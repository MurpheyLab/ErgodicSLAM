...
erg_ctrl_sim2.plot(point_size=1, save=None)
erg_ctrl_sim2.animate3(point_size=1, alpha=1, show_traj=True, title='Landmarks Distribution Test', rate=50)
