...
# erg_ctrl = RTErgodicControl(model, t_dist, horizon=40, num_basis=20, batch_size=50) # last time
erg_ctrl = RTErgodicControl(model, t_dist, horizon=15, num_basis=25, batch_size=30)
...
"""start simulation"""
tf = 500
erg_ctrl_sim = simulation(size, init_state, model, erg_ctrl, env, tf, ped_data=ped_data, space=space)
erg_ctrl_sim.start()
