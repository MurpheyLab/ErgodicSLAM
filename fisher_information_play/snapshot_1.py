...
ax1.set_xlim(0, 20)
ax1.set_ylim(0, 20)
ax1.set_title('Simulation', fontsize=20, pad=10)
...
ax1.legend(['Robot Pose', 'Landmark'], fontsize=20, shadow=True)
...
ax2.set_title('Fisher Information', fontsize=20, pad=10)
...
ax3.set_title('Occupancy Grid Map', fontsize=20, pad=10)
...
ax4.set_title('Mutual Information', fontsize=20, pad=10)
...
ax5.set_title('Combined Target Distribution', fontsize=25)
