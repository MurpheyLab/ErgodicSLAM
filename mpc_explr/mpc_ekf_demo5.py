...
from rt_erg_lib.ekf_mpc_simulation5 import simulation_slam
...
erg_ctrl_sim = simulation_slam(size, init_state, t_dist, modelTrue, ergCtrlTrue, envTrue, modelDR, ergCtrlDR, envDR, tf, landmarks, sensor_range, motion_noise, measure_noise, static_test=45, horizon=25, switch=100)
