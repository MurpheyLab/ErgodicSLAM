...
landmarks1 = np.random.uniform(10.0, 18.0, size=(10, 2))
landmarks2 = np.random.uniform(2.0, 10.0, size=(10, 2))
landmarks = np.concatenate((landmarks1, landmarks2))
...
erg_ctrl_sim.animate(point_size=1, show_traj=True, title='Landmarks Distribution Test')
